...
import (
	...
	"github.com/gitpod-io/gitpod/ws-daemon/pkg/hostsgov"
...
type Config struct {
	...
	Content        syncd.Config       `json:"content"`
	Uidmapper      uidmap.Config      `json:"uidmapper"`
	Resources      resourcegov.Config `json:"resources"`
	Hosts          hostsgov.Config    `json:"hosts"`
